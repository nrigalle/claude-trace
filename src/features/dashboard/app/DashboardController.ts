...
import type {
  WatcherChange,
  WatcherSource,
} from "../infra/SessionDirectoryWatcher";
import type { SerializedState } from "../infra/PanelSerializer";
import type { DetailLayoutEntry, WebviewToHost } from "../protocol";
  ...
  private onMessage(msg: WebviewToHost): void {
    switch (msg.type) {
      ...
      case "copyConversation":
        this.actions.copyConversation(msg.sessionId);
        return;
      case "togglePin":
